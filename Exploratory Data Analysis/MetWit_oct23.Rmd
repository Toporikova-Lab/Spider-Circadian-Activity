...
#filter 1 and 2 sec events
#figure out how to stitch certain events that we can consider as 1 long movement

#run a spider simulatotion
#try to create a best fit line (poisson(exp) or beta distribution)
#fix the bidwidths 
